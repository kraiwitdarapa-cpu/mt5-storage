...
// Builds the "Follow BUY" / "Counter SELL" / "Sideway Price BUY" style
// text purely by concatenating the Mode and Signal text the active
// engine already stored - no new trading meaning is derived.
string KAI_TrendText(string modeTxt, string signalTxt)
{
   if(signalTxt != "BUY" && signalTxt != "SELL") return "-";

   string prefix;
   if(modeTxt == "FOLLOW")                         prefix = "Follow";
   else if(modeTxt == "COUNTER" || modeTxt == "REVERSAL") prefix = "Counter";
...
void UpdateDashboard()
{
   ...
   KAI_SetDashLine("TREND",  "TREND         : " + KAI_TrendText(modeTxt, signalTxt), KAI_BuySellColor(signalTxt));
   ...
   KAI_PublishBridgeSnapshot(engineTxt, KAI_TrendText(modeTxt, signalTxt), riskTxt,
